...
pca_descriptions <- tribble(~'component',~"Positive",~"Negative",
                            ...
                            "PC3", "Punt TE/RB for QB", "Punt QB for TE/RB",
                            "PC4", "Early TEs + RB Depth over QB Depth", "QB Depth over RB/TE depth",
                            "PC5", "Anchor WRs", "Anchor RBs",
                            "PC6", "Value QBs and Depth", "Reaching on QBs and depth RB/WR",
                            "PC7", "Anchor RB + Early QB2", "Late RB1/QB2",
...
ggiraph::girafe(ggobj = pca_userplot)
