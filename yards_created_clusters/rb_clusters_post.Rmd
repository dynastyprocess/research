...
yards_created_df %>%
  left_join(rb_seaons_wide, by = c("name" = "gsis_name")) %>%
  select(ppr_ppg_total, draft_pick, yc_per_attempt, mtf_per_attempt, rec_yard_per_pass_play, rec_share, total_yards_per_team_play) %>%
...
Below you can see the distributions of the predictive metrics in each of the Principal components. These curves demonstrate how the PCA functioned on the actual data.
